...
struct StepInfo {
  ...
  /// The time, in seconds, that the last discrete update was performed. Same
  /// caveat about time resolution degradation (above) applies. The initial
  /// conditions are treated as a discrete update, so this variable should
  /// always hold a valid value.
