...
#pragma GCC diagnostic pop
    ...
    cls  // BR
        ...
        .def("HasBodyNamed",
            overload_cast_explicit<bool, const string_view&>(
                &Class::HasBodyNamed),
        ...
        .def("GetFrameByName",
            overload_cast_explicit<const Frame<T>&, const string_view&>(
        ...
        .def("GetBodyByName",
            overload_cast_explicit<const Body<T>&, const string_view&>(
                &Class::GetBodyByName),
            py::arg("name"), py_rvp::reference_internal,
        ...
        .def("GetJointByName",
            [](const Class* self, const string_view& name,
        ...
        .def("GetMutableJointByName",
            [](Class * self, const string_view& name,
                std::optional<ModelInstanceIndex> model_instance) -> auto& {
