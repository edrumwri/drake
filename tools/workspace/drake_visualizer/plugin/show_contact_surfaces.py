...
class ContactSurfacesVisualizer(object):
    def __init__(self):
        self._folder_name = 'Contact Surfaces'
        self._name = "Contact Surfaces Visualizer"
        self._enabled = False
        self._sub = None
    ...
    def add_subscriber(self):
        ...
        self._sub = lcmUtils.addSubscriber(
            'CONTACT_SURFACES',
            messageClass=lcmdrakemsg.lcmt_contact_surfaces_for_viz,
    ...
    def handle_message(self, msg):
        ...
        for surface in msg.contact_surfaces:
...
def init_visualizer():
    ...
    my_visualizer = ContactSurfacesVisualizer()
